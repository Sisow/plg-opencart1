  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
    <table class="form">
      <tr>
        ...
        <td colspan="2"><input type="text" name="sisowfocum_merchantid" value="<?php echo $sisowfocum_merchantid; ?>" />
          <br />
      ...
      <tr>
        ...
        <td colspan="2"><input type="text" name="sisowfocum_merchantkey" value="<?php echo $sisowfocum_merchantkey; ?>" />
          <br />
          <?php if ($error_username) { ?>
          <span class="error"><?php echo $error_username; ?></span>
          <?php } ?></td>
	  ...
	  <tr>
            ...
            <td colspan="2"><input type="text" name="sisowfocum_shopid" value="<?php echo $sisowfocum_shopid; ?>" /></td>
          </tr>  
      <tr>
      <tr>
        <td><?php echo $entry_success; ?></td>
        <td colspan="2"><select name="sisowfocum_status_success">
	  ...
	  <tr>
        ...
        <td colspan="2"><select name="sisowfocum_testmode">
	  ...
	  <tr>
        ...
        <td colspan="2"><input type="text" name="sisowfocum_paymentfee" value="<?php echo $sisowfocum_paymentfee; ?>" /></td>
      </tr>
          <tr>
            <td><?php echo $entry_sisowfocumfee_tax; ?></td>
            <td><select name="sisowfocumfee_tax">
          ...
          <tr>
            ...
            <td colspan="2"><input type="text" name="sisowfocum_total" value="<?php echo $sisowfocum_total; ?>" /></td>
          </tr>          
          <tr>
            <td><?php echo $entry_totalmax; ?></td>
            <td colspan="2"><input type="text" name="sisowfocum_totalmax" value="<?php echo $sisowfocum_totalmax; ?>" /></td>
          </tr>          
        <tr>
          <td><?php echo $entry_geo_zone; ?></td>
          <td><select name="sisowfocum_geo_zone_id">
      ...
      <tr>
        ...
        <td colspan="2"><select name="sisowfocum_status">
      ...
      <tr>
        ...
        <td colspan="2"><input type="text" name="sisowfocum_sort_order" value="<?php echo $sisowfocum_sort_order; ?>" size="1" /></td>
      </tr>
      <tr>
