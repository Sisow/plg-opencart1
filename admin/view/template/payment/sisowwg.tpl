  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
    <table class="form">
	  ...
	  <tr>
            ...
            <td colspan="2"><input type="text" name="sisowwg_shopid" value="<?php echo $sisowwg_shopid; ?>" /></td>
          </tr>  
      <tr>
      ...
      <tr>
        ...
        <td colspan="2"><input type="text" name="sisowwg_paymentfee" value="<?php echo $sisowwg_paymentfee; ?>" /></td>
      </tr>
          <tr>
            <td><?php echo $entry_sisowwgfee_tax; ?></td>
            <td><select name="sisowwgfee_tax">
                <option value=""><?php echo $text_none; ?></option>
                <?php foreach ($tax_classes as $tax_class) { ?>
                <?php if ($tax_class['tax_class_id'] == $sisowwgfee_tax) { ?>
