  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
    <table class="form">
      <tr>
        ...
        <td colspan="2"><input type="text" name="sisowvvv_merchantid" value="<?php echo $sisowvvv_merchantid; ?>" />
          <br />
      ...
      <tr>
        ...
        <td colspan="2"><input type="text" name="sisowvvv_merchantkey" value="<?php echo $sisowvvv_merchantkey; ?>" />
          <br />
          <?php if ($error_username) { ?>
          <span class="error"><?php echo $error_username; ?></span>
          <?php } ?></td>
	  ...
	  <tr>
            ...
            <td colspan="2"><input type="text" name="sisowvvv_shopid" value="<?php echo $sisowvvv_shopid; ?>" /></td>
          </tr>  
      <tr>
      <tr>
        <td><?php echo $entry_success; ?></td>
        <td colspan="2"><select name="sisowvvv_status_success">
      ...
      <tr>
        ...
        <td colspan="2"><select name="sisowvvv_testmode">
	  ...
	  <tr>
        ...
        <td colspan="2"><input type="text" name="sisowvvv_paymentfee" value="<?php echo $sisowvvv_paymentfee; ?>" /></td>
      </tr>
          <tr>
            <td><?php echo $entry_sisowvvvfee_tax; ?></td>
            <td><select name="sisowvvvfee_tax">
                <option value=""><?php echo $text_none; ?></option>
                <?php foreach ($tax_classes as $tax_class) { ?>
                <?php if ($tax_class['tax_class_id'] == $sisowvvvfee_tax) { ?>
          ...
          <tr>
            ...
            <td colspan="2"><input type="text" name="sisowvvv_total" value="<?php echo $sisowvvv_total; ?>" /></td>
          </tr>          
          <tr>
            <td><?php echo $entry_totalmax; ?></td>
            <td colspan="2"><input type="text" name="sisowvvv_totalmax" value="<?php echo $sisowvvv_totalmax; ?>" /></td>
          </tr>          
        <tr>
          <td><?php echo $entry_geo_zone; ?></td>
          <td><select name="sisowvvv_geo_zone_id">
      ...
      <tr>
        ...
        <td colspan="2"><select name="sisowvvv_status">
      ...
      <tr>
        ...
        <td colspan="2"><input type="text" name="sisowvvv_sort_order" value="<?php echo $sisowvvv_sort_order; ?>" size="1" /></td>
      </tr>
      <tr>
