  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
    <table class="form">
	  ...
	  <tr>
            ...
            <td colspan="2"><input type="text" name="sisowde_shopid" value="<?php echo $sisowde_shopid; ?>" /></td>
          </tr>  
      <tr>
      <tr>
      ...
      <tr>
        ...
        <td colspan="2"><input type="text" name="sisowde_paymentfee" value="<?php echo $sisowde_paymentfee; ?>" /></td>
      </tr>
          <tr>
            <td><?php echo $entry_sisowdefee_tax; ?></td>
            <td><select name="sisowdefee_tax">
                <option value=""><?php echo $text_none; ?></option>
                <?php foreach ($tax_classes as $tax_class) { ?>
                <?php if ($tax_class['tax_class_id'] == $sisowdefee_tax) { ?>
